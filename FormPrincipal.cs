...
namespace WindowsFormsBD
{
    public partial class FormPrincipal : Form
    {
        ...
        private void FormPrincipal_Load(object sender, EventArgs e)
        {
            ...
            toolStripLabelUser.Text = "ID_User:" + Geral.id_user;
            toolStripButtonLogOut.Enabled = true;

            //if (formAutenticacao.DialogResult == DialogResult.OK)
            //{
            //    string userName = formAutenticacao.UserName();
            //    toolStripLabelUser.Text = userName;
            //}
        }

        private void toolStripButtonLogOut_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Deseja efectuar logout?\nTotas as janelas serão fechadas.","LogOut",
